...
object Model {
  ...
  def createMbankModel(fundRepo: FundRepository): Experiment = {
    ...
    val from = ExtendedDate.createFromString("01-01-2000", "mm-dd-yyy")
    val to = new ExtendedDate() //.addDays(-10)
    val params = new Params(197, 0.1, Array(-3.475592758765317,2.060086542490935,-5.434080608376035,9.37507562364051,-3.4187654428464525,-2.2187809608794398,-6.55698369504694,-3.587286123649554,1.4583999062326591,-0.34664415800866133))
    val initialFund = 0
    val initialValue = 1000
