...
val actualValue1 = fund1.getQuoteForDate(date1).get
val actualValue1b = fund1.getQuoteForDate(date2).get
...
val actualValue2 = fund2.getQuoteForDate(date1).get
val actualValue2b = fund2.getQuoteForDate(date2).get
...
val actualValue3 = fund1.getQuoteForDate(date3).get
assert(actualValue3 == None, "Expected None, got: " + actualValue3)

val actualValue4 = fund1.getQuoteForDate(date4).get
